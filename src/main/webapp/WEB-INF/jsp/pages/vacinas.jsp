...
function editar(id){
	...
	var inicio = 'x';
	var fim = 'x';
	<c:forEach items="${vacinas }" var="v" varStatus="s">
		if(${v.id} == id){
			document.getElementById("nome").value = '${v.nome}';
			document.getElementById("idValor").value = ${v.id};
		}
	</c:forEach>
...
<div class="row">
<form action="/vacinas" method="post" accept-charset="utf-8">
	<div class="col-md-12">
		<div data-collapsed="0" class="panel">
			<div class="panel-heading">
				<div class="panel-title">
					...
					<h2 class="panel-title" id="">Cadastrar nova Vacina </h2>
				</div>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-md-4 form-group">
						<input type="text" placeholder="Nome" name="vacinaNome" id="nome" class="form-control" required>
					</div>
...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Registro das Vacinas</h2>
							</header>
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default" style="overflow:auto">
									...
									<tbody>
										<c:forEach items="${vacinas }" var="p">
											<tr class="gradeX">
												<c:if test="${usuarioSessao.perfil.admin }">
													<td>
														<i class="fa fa-trash" onclick="modalDeletar('vacinas', ${p.id}) "></i> &nbsp
